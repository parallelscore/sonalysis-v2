...
import { getCall, deleteCall } from '../../../../api/request';
...
const AllClubs = () => {
    ...
    function getAllClubs(status) {
        setIsLoading(true);
        getCall(endPoint.getClubsByCoachId(profile._id, status)).then(
            async (res) => {
                if (res?.status === 200) {
                ...
                <div className='video-tab'>
                    ...
                    <div className='tab-section'>
                        ...
                        <div
                            ...
                            onClick={() => handleChangeTab(3, 'rejected')}
                        >
                            Rejected
                        </div>
                    </div>
