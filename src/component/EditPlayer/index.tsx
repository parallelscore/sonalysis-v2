          ...
          <>
            ...
            <form className=" col-lg-10 mt-5 mx-auto">
              <div className="form-group col-lg-4 mx-auto">
                <label htmlFor="clubLogo" className="logo">{filePhoto&&<img src={filePhoto}  alt="logo"/>}
              {!filePhoto&&"Upload Image"}</label>
                <input type="file" name="photo" id="clubLogo" className="logo-file" onChange={handleOnchange} />
              </div>
