...
import StatImg from "../../assets/images/about.jpg";
        ...
        <div className="container d-flex">
          ...
          <div className="about-about-right col-lg-6 ">
            ...
            <div className="about-about-right-text col-lg-8">
              <p>
                Sonalysis is our aim at providing/delivering in real time
                detailed analytics of a soccer game to users right from their
                comfort in Africa and beyond. We hope to distribute information
                to both technical and non-technical users by making our
                application user friendly and easily accessible.
              </p>
              <p>
                Creating a web application that can collate analytical data from
                a soccer match that will be accessible to anyone.
              </p>
            </div>
          </div>
        ...
        <div className="container d-flex second">
          <div className="about-about-right col-lg-6  ">
            ...
            <div className="about-about-right-text col-lg-10 ml-5">
              <p>
                Creating a soccer analytics applications that can compete with
                the likes of Sportlogiq for real time analysis of soccer games
      ...
      <div className="about-feature pt-5">
        <div className="container">
          ...
          <p className="text-center">
            We care about what you care about, so we deliever with you in mind
          </p>
          <div className="d-lg-flex justify-content-between mt-5">
            <div className="team-card">
              ...
              <div className="role text-center">R & D Software Engineer</div>
            </div>
            <div className="team-card">
              <div className="team-photo">
            ...
            <div className="team-card">
              ...
              <div className="role text-center">Product Designer</div>
            </div>
            <div className="team-card">
              <div className="team-photo">
              ...
              <div className="role text-center">Frontend/Mobile Engineer</div>
            </div>
          </div>
